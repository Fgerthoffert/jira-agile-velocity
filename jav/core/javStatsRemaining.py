    ...
    def main(self):
        ...
        for current_day_data in current_data:
            if date_current.strftime('%Y-%m-%d') != current_data[current_day_data]['datetime'].strftime('%Y-%m-%d'):
                dict_idx = current_day_data[current_day_data]['datetime'].strftime('%Y-%m-%d')
                daily_data[dict_idx] = current_day_data[current_day_data]
        ...
        for currentdata in daily_data:
            ...
            daily_obj['datetime'] = daily_data[currentdata]['datetime']
