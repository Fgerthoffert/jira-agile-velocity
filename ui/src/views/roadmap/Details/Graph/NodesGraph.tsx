...
type connectedProps = ReturnType<typeof mapState | any> & ReturnType<typeof mapDispatch>;
		...
		if (issuesGraph.length > 0) {
			...
			cy.on('mouseover', 'node', (event: any) => {
				...
				if (this.tippyInstances[nodeId] === undefined) {
					this.tippyInstances[nodeId] = this.makeTippy(node, dataNode.summary + ' (' + dataNode.key + ')');
