			...
			<Grid container direction='column' justify='flex-start' alignItems='stretch' spacing={1}>
				<Grid item xs={12}>
					<Paper className={classes.root}>
						...
						<RoadmapFutureChart roadmap={roadmap} defaultPoints={defaultPoints} />
						<br />
						<Typography component='p' className={classes.smallText}>
							<i>
								Displays initiatives assigned to a team, sorted as per the source JQL query. Uses the
								team's current weekly velocity and remaining effort in {metric} to build a timeline
								(week ending).
							</i>
						</Typography>
					</Paper>
				...
				<Grid item xs={12}>
					<InitiativeTable
						initiatives={roadmap.futureCompletion.map((i: any) => {
							const sourceInitiatice = roadmap.initiatives.find((si: any) => si.key === i.key);
							return {
								...i,
								children: sourceInitiatice !== undefined ? sourceInitiatice.children : undefined
							};
						})}
